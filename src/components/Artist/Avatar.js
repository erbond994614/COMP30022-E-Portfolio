...
export default function Avatar(props) {
  ...
  const avatar = useSelector(
    (state) => state.userAuth.user.portfolio.profilePicture
  );
  ...
  return (
    <div
      ...
      onMouseEnter={() => setUploadShow(true)}
      onMouseLeave={() => setUploadShow(false)}
    >
      <div
        className={`avatar-upload ${uploadShow ? "show" : ""}`}
